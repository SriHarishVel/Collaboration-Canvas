...
function Canvas() {
  ...
  const getColorForUser = (username) => {
    ...
    if (!userColorMap[username]) {
      ...
      const assignedCount = Object.keys(userColorMap).length;
      const colorIndex = assignedCount % userColorPalette.length;
      setUserColorMap(prev => ({ ...prev, [username]: userColorPalette[colorIndex] }));
      setColorIndexMap(prev => ({ ...prev, [username]: colorIndex }));
    }
    return userColorMap[username] || '#000000';
  };
