...
- Check WebSocket URL in client code matches server address
- Verify firewall is not blocking WebSocket connections

### Drawing Not Showing
- Check browser console for errors
- Verify Socket.IO connection is established (look for "Connected to server" log)
- Ensure canvas size is properly set

### Undo/Redo Not Working
- Undo only works on your own strokes
- Check that you have strokes on the canvas
